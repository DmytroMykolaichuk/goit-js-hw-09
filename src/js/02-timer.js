...
function onTimer() {
    intervalId = setInterval(() => {
        ...
        if (second.textContent === '00' && minutes.textContent === '00' &&  hours.textContent === '00' && days.textContent === '00') {
...
// second.textContent === '00' && minutes.textContent === '00' &&  hours.textContent === '00' && days.textContent === '00'